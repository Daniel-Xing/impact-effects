...
sub calc_energy {
    ...
    print "energy0_megatons = $energy0_megatons\n";
...
sub atmospheric_entry
  {
    ...
    if ($iFactor >= 1) {	# projectile lands intact
      ...
      print "velocity_at_zero = $velocity\n";
...
### post:  returns the richter magnitude of the seismic disturbance caused by impact
{
  ...
  print "eff_mag = $eff_mag\n";
  $seismic_arrival = $distance / $surface_wave_v;
  print "seismic_arrival = $seismic_arrival\n";
...
sub find_crater()
  {
    ...
    print "cdiameter = $cdiameter\n";
    print "depthfr = $depthfr\n";

    $vCrater = ($pi / 24) * ($Dtr/1000)**3;
    print "vCrater = $vCrater\n";
...
sub find_ejecta
  {
    ...
    print "ejecta_arrival = $ejecta_arrival\n";
    
    $ejecta_thickness = $Dtr**4/(112 * ($distance * 1000)**3);
    print "Dtr = $Dtr, distance = $distance, ejecta_thickness = $ejecta_thickness\n";
...
sub find_thermal
  {
    ...
    print "thermal_exposure, no_radiation, max_rad_time, irradiation_time, megaton_factor, thermal_power = $thermal_exposure, $no_radiation, $max_rad_time, $irradiation_time, $megaton_factor, $thermal_power\n";
...
sub tsunami
  {
    ...
    print "tdensity = $tdensity \n";
    print "TsunamiArrivalTime = $TsunamiArrivalTime\n";
    ...
    print "WaveAmplitudeUpperLimit = $WaveAmplitudeUpperLimit\n";
    print "WaveAmplitudeLowerLimit = $WaveAmplitudeLowerLimit\n";
...
sub print_atmospheric_entry
  {
    ...
    print "before energy_surface: $energy_surface \n";
    ...
    print "end energy_surface: $energy_surface\n";
  }
